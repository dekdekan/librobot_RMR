...
////*************************************************************************************
////*************************************************************************************
//// autor Martin Dekan  a Peter Beno mail: dekdekan@gmail.com,
///peter.beno@stuba.sk
////-------------------------------------------------------------------------------------
//// co to je:
//// trieda na pracu s robotom kobuki. mala by mat implementovane citanie dat
//// a posielanie prikazov...
//// neobsahuje ziadnu logiku co s datami robit, to je na userovi aby spravil v
///callback funkcii
...
typedef struct {
  ...
  // gombiky
  unsigned char
      ButtonPress; // 0 nie, 1 2 4 pre button 0 1 2 (7 je ze vsetky tri)
  // napajanie
...
typedef long (*src_callback_kobuki_data)(void *user_data,
                                         TKobukiData &Kobuki_data);
...
public:
  ...
  setLed(int led1 = 0,
         int led2 = 0); // led1 zelena/cervena 2/1, //led2 zelena/cervena 2/1
...
private:
  ...
  //--spustenie merania v novom vlakne (vycitavanie bezi v novom vlakne. treba
  //ho stopnut ak chceme poslat request)
